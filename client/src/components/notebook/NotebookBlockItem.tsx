...
export function NotebookBlockItem({
  ...
  // Video upload with strict 10-minute check
  ...
  return (
    <div className="group relative flex items-start gap-2 rounded-xl border border-transparent p-1.5 transition-all duration-200 hover:border-slate-200/80 hover:bg-slate-50/50 dark:hover:border-slate-800/80 dark:hover:bg-slate-900/30">
      ...
      <div className="min-w-0 flex-1">
          ...
          <div className="space-y-2 rounded-2xl border border-slate-200/80 bg-slate-50/50 p-3 dark:border-slate-800/80 dark:bg-slate-900/40">
            ...
            {block.content ? (
              <div className="space-y-2">
                <div className="relative group/img overflow-hidden rounded-xl border border-slate-200/80 bg-slate-950 dark:border-slate-800">
                  <img
                    src={block.content}
                    alt={block.meta?.caption || "Notebook attachment"}
                    className="max-h-[500px] w-full object-contain cursor-pointer transition-transform duration-300 hover:scale-[1.01]"
              ...
              >
                ...
                <div>
                  <div className="text-xs font-bold text-slate-800 dark:text-slate-200">
                    {isBn ? "স্ক্রিনশট বা ইমেজ আপলোড করুন" : "Upload Screenshot or Image"}
                  </div>
        ...
        {/* 9. VIDEO (Strict <= 10 Minutes Check) */}
        {block.type === "video" && (
          <div className="space-y-2 rounded-2xl border border-slate-200/80 bg-slate-50/50 p-3 dark:border-slate-800/80 dark:bg-slate-900/40">
            <input
              type="file"
            ...
            {block.content ? (
              ...
              >
                ...
                <div>
                  <div className="text-xs font-bold text-slate-800 dark:text-slate-200">
                    {isBn ? "ভিডিও আপলোড করুন (সর্বোচ্চ ১০ মিনিট)" : "Upload Video Clip (Strict Max 10 Minutes)"}
                  </div>
                  <div className="text-[11px] text-slate-400">
                    {isBn ? "ট্রেডিং সেশন বা সেটআপ রেকর্ড (MP4, WEBM)" : "Screen recordings & breakdown clips"}
                  </div>
                </div>
              </div>
            )}
