          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <div className="font-extrabold">QPC</div>
            ...
            {/* ragf Book (Default Active in user screenshot) */}
            <button
            ...
            >
              <BookOpen className="h-4 w-4 text-cyan-400" />
              <div className="text-left">
                <div className="font-extrabold">ragf</div>
